 ...
 *      key is also called as Property or attribute (usually called as property in his experience)
 * 
 * syntax: 
 * 
 * let objectName {}        // Empty object
 *      or
 * let objectName = new object();       // Empty object - this method will not be used in practical life 
 * 
 * let objectName = {
 *      key1 : Value1, 
 *      key2 : value2,
 *      key3 : value 3 (no comma here)
 * }
 * 
 * keys have to be unique in an object and the datatype is a STRING
 * keys can be digit, can be string (with or without spaces)
 * when you print entire object or apply for-in loop on the object: 
 *      Keys which are digits are going to be printed first and in sorted order 
 ...
 */
 let myObj = {
    ...
    age : 20,
    true : 22
}; // you can use for-in loops with objects
