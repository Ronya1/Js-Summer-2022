...
// Print array values in revers order -> cant do that -> better to use the normal for loop 
// Print arrayvalues from even-index -> cant do that -> better to use the normal for loop 
